...
export function getDraftArticlePrompt(
  ...
  Поверни відповідь СУВОРO у форматі JSON об'єкта:
  {
    ...
    "keywords": "Ключові слова через кому (короткі лаконічні поняття по 1-2 слова). Перші два слова ОБОВ'ЯЗКОВО мають бути максимально візуальними та простими для пошуку фото (наприклад: 'гори, ліс', 'спа, басейн', 'готель, релакс', 'кава, чашка'). Уникай довгих SEO-фраз із назвами міст у перших тегах.",
