...
export function getDraftArticlePrompt(
  ...
  Поверни відповідь СУВОРO у форматі JSON об'єкта:
  {
    ...
    "keywords": "Ключові слова виключно у формі ІМЕННИКІВ по ОДНОМУ слову через кому, БЕЗ повторів (наприклад: 'гори, басейн, готель, масаж, природа, карпати, відпочинок'). Перші 2 іменники ОБОВ'ЯЗКОВО мають бути максимально візуальними та простими об'єктами для пошуку фото на Unsplash.",
